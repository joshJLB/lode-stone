    ...
    <div class="four-container" style="background-image:url(<?=get_field('four_image'); ?>);">
      ...
      <div class="four-blog-container">
        ...
        <div class="four-blog-post">
          ...
          <p class="four-blog-content"><?=$mostRecent1['post_content']?></p>
        ...
        <div class="four-blog-post">
          ...
          <p class="four-blog-content"><?=$mostRecent2['post_content']?></p>
        ...
        <div class="four-blog-post">
          ...
          <p class="four-blog-content"><?=$mostRecent3['post_content']?></p>
